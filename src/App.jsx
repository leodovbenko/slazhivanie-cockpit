...
const SOL = {
  ...
  "Маркетинг-лид": { icon: Activity, color: c.cyan, sub: "Тим-лид маркетинга · единый P&L", cat: "Маркетинг",
    ...
    pitch: "Агент агентов: сводит весь маркетинг в один P&L — от охвата до сделок и повторных платежей, с ценой движения и разбивкой по каналам. Находит узкое место, сверяется с рынком и ставит задачи функциям-исполнителям (Гермес, аутрич, SEO) — под ваш «Ок».",
    landing: {
      ...
      problem: "Не видно, какой канал приносит клиентов, а какой просто жжёт бюджет. Усилия размазаны, узкое место воронки не найти, решения принимаются на ощущениях. Аналитику никто не сводит воедино — потому что это долго и вручную.",
      solution: "Маркетинг-лид собирает всё в один отчёт-воронку — от охвата и посещений сайта до заявок, сделок, продлений и повторных платежей, с ценой каждого движения и разбивкой по каналам (реклама, органика, соцсети, нейросети). Сверяется с рынком поиском в интернете, находит узкое место и ставит задачи функциям-исполнителям — под ваш «Ок»: прибыльные каналы расширить, убыточные погасить.",
      benefit: "Один P&L вместо десяти вкладок. Видно, откуда приходят клиенты и почём, как соотносятся стоимость привлечения и ценность клиента, куда стоит добавить денег, а откуда убрать. Агент, который держит маркетинг как единое целое и растёт от советчика до управляющего целями команды.",
    } },
