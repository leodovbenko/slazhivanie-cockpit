...
const SOL = {
  ...
  Recruiter: { icon: UserCheck, color: c.blue, sub: "AI-агент-рекрутер", cat: "Найм и HR", soon: true,
    devStatus: "Ядро — коннектор к hh.ru, оценка резюме по светофору, доска найма, калибровка на ваших исправлениях и открытый экран настройки промпта — уже работает на проде. Дальше по дорожной карте: лидерборд финалистов и оффер как отдельный шаг. Живой демо-дашборд появится здесь, когда агент выйдет в кокпит.",
