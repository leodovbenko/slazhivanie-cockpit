...
const SOL = {
  ...
  "Комьюнити": { icon: Users, color: c.clay, sub: "AI комьюнити-менеджер · закрытый чат-сообщество", cat: "Сообщество", soon: true,
    devStatus: "Вечерний дайджест «вопрос → как решилось» по реальным тредам ответов — уже на проде. Дальше по дорожной карте — ответы на вопросы по чату, недельный топ благодарностей и активности, модерация. Живой демо-дашборд появится здесь, когда агент выйдет в кокпит.",
    task: "Ценные вопросы и ответы тонут в потоке чата-сообщества",
    result: "Каждый вечер — дайджест «вопрос → как решилось» обратно в чат. Ничего разобранного не теряется.",
    effect: "Меньше рутины", speed: "С нашим спецом",
    tags: ["Дайджест", "Знание", "Активность", "Модерация"],
    pitch: "Читает закрытый чат-сообщество с атрибуцией и каждый вечер присылает обратно в чат дайджест дня: какие вопросы задали и как их решили — тредами по реальным ответам-reply, а не выдуманным связям. В тихий день молчит. Знание сообщества держит отдельной полкой, не растворяя в памяти компании. Дальше — Q&A по чату, счёт благодарностей и активности, модерация. Промпт дайджеста редактирует оператор.",
    landing: {
