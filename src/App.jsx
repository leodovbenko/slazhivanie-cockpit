...
const SOL = {
  ...
  Hermes: { icon: Zap, color: c.cyan, sub: "LinkedIn-автопилот", cat: "Маркетинг",
    ...
    landing: {
      ...
      benefit: "Регулярный контент почти без твоего времени: минута на одобрение вместо часа на текст. В демо — 24 500 охвата и до 83 000 показов на топ-пост по MENA, 100% в твоём голосе. А где ты правишь его посты, платформа замечает разницу и на этом его подкручивает — со временем правок меньше.",
    } },
