...
const SOL = {
  ...
  Recruiter: { icon: UserCheck, color: c.blue, sub: "AI-агент-рекрутер", cat: "Найм и HR", soon: true,
    devStatus: "Фаза 1 — коннектор к hh.ru и зеркало откликов — уже на проде. Модуль оценки (светофор по резюме) проектируется по ТЗ. Живой демо-дашборд появится здесь, как только оценка выйдет в кокпит.",
