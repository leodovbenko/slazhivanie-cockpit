...
const SOL = {
  ...
  Hermes: { icon: Zap, color: c.cyan, sub: "Контент-машина · LinkedIn, каналы, блог", cat: "Маркетинг",
    ...
    pitch: "Сырая мысль на входе — пост в твоём голосе на выходе, по расписанию. Один повод раскладывает по всем каналам и публикует статьи в твой блог — после проверки бренда. Правила голоса само-обновляются из аналитики.",
    landing: {
      ...
      benefit: "Регулярный контент почти без твоего времени: минута на одобрение вместо часа на текст. Один повод — сразу под все каналы и в блог, а не переписывание под каждый вручную. В демо — 24 500 охвата и до 83 000 показов на топ-пост по MENA, 100% в твоём голосе. А где ты правишь его посты, платформа замечает разницу и на этом его подкручивает — со временем правок меньше.",
    } },
